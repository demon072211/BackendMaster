                                    ...
                                    <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-2 text-right">
                                                Tổng số bản ghi : <?php if(!empty($data)): ?> <?php echo e($data->total()); ?> <?php endif; ?>
                                            </div>
                                            <div class="col-12">
                                                <div class="card">
                                                    <!-- /.card-header -->
                                                    <div class="card-body table-responsive p-0">
                                                        <table class="table table-hover text-nowrap">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th><?php echo e(__('base.3_card')); ?></th>
                                                                <th><?php echo e(__('base.skiller_13')); ?></th>
                                                                <th><?php echo e(__('base.sedie')); ?></th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($item['bacay']); ?></td>
                                                                <td><?php echo e($item['tlmn']); ?></td>
                                                                <td><?php echo e($item['xocdia']); ?></td>
                                                            </tr>
                                                            <?php $firstItem++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/www/daily/resources/views/gameStatic/poker.blade.php ENDPATH**/ ?>