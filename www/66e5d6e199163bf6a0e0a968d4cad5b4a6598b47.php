...
<?php $__env->startSection('title', __('base.withdrawal_history')); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><?php echo e(__('base.withdrawal_history')); ?></h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('base.home')); ?></a></li>
                            <li class="breadcrumb-item active"><?php echo e(__('base.withdrawal_history')); ?></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    <form method="get" action="<?php echo e(route('withdraw')); ?>">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?php echo e(route('withdraw')); ?>" class="btn btn-primary"><?php echo e(__('base.quit_search')); ?></a>
                        </div>
                    </form>
                </div>
                <div class="row">
                                    ...
                                    <?php if(!empty($data) && $data->total()): ?>
                                        ...
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(empty($item['CartId']) ? '' : $item['CartId']); ?></td>
    ...
    <?php echo $__env->make("topup.approveWithDraw", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- Modal -->
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $("#form-reject").submit(function( event ) {
            ...
            $.ajax({
                    type: 'post',
                    url: '<?php echo e(route('withdraw-reject')); ?>',
                    data: data,
        ...
        $("#form-approve").submit(function( event ) {
            ...
            $.ajax({
                    type: 'post',
                    url: '<?php echo e(route('withdraw-approve')); ?>',
                    data: data,
                    success: function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/www/daily/resources/views/topup/withdraw.blade.php ENDPATH**/ ?>