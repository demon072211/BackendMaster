    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content background-modal">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('base.cancel')); ?></h5>
...
</div><?php /**PATH /var/app/www/daily/resources/views/transaction/delete.blade.php ENDPATH**/ ?>