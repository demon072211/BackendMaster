    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content background-modal">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('base.delete')); ?></h5>
...
</div><?php /**PATH /var/app/www/daily/resources/views/bank/delete.blade.php ENDPATH**/ ?>