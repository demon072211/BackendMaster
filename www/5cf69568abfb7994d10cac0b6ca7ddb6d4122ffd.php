...
<?php $__env->startSection('title', __('base.game_stats')); ?>
                                                    ...
                                                    <div class="card-body table-responsive p-0">
                                                        <table class="table table-hover text-nowrap">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th><?php echo e(__('base.slot_bitcoin')); ?></th>
                                                                <th><?php echo e(__('base.slot_monkey_king')); ?></th>
                                                                <th><?php echo e(__('base.slot_angry_birds')); ?></th>
                                                                <th><?php echo e(__('base.slot_fortune')); ?></th>
                                                                <th><?php echo e(__('base.slot_sport')); ?></th>
                                                                <th><?php echo e(__('base.slot_astrology')); ?></th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($item['bitcoint']); ?></td>
                                                                <td><?php echo e($item['taydu']); ?></td>
                                                                <td><?php echo e($item['angrybird']); ?></td>
                                                                <td><?php echo e($item['thantai']); ?></td>
                                                                <td><?php echo e($item['thethao']); ?></td>
                                                                <td><?php echo e($item['chiemtinh']); ?></td>
                                                            </tr>
                                                            <?php $firstItem++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/www/daily/resources/views/gameStatic/nohu.blade.php ENDPATH**/ ?>