...
<?php $__env->startSection('title', __('base.mini_game')); ?>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><?php echo e(__('base.mini_game')); ?></li>
                        </ol>
                    </div>
                </div>
            </div>
                                                        ...
                                                        <div class="card-body table-responsive p-0">
                                                            <table class="table table-hover text-nowrap">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th><?php echo e(__('base.big_small')); ?></th>
                                                                    <th><?php echo e(__('base.gourd_crab')); ?></th>
                                                                    <th><?php echo e(__('base.slot_pokemon')); ?></th>
                                                                    <th><?php echo e(__('base.upper_under')); ?></th>
                                                                    <th><?php echo e(__('base.mini_poker')); ?></th>
                                                                    <th><?php echo e(__('base.big_small_speed')); ?></th>
                                                                </tr>
                                                                </thead>
                                                                <tbody>
                                                                <?php if(!empty($data) && $data->total()): ?>
                                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo e($item['taixiu']); ?></td>
                                                                            <td><?php echo e($item['baucua']); ?></td>
                                                                            <td><?php echo e($item['slot_pokemon']); ?></td>
                                                                            <td><?php echo e($item['caothap']); ?></td>
                                                                            <td><?php echo e($item['minipoker']); ?></td>
                                                                            <td><?php echo e($item['taixiu_st']); ?></td>
                                                                        </tr>
                                                                    <?php $firstItem++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/app/www/daily/resources/views/gameStatic/miniGame.blade.php ENDPATH**/ ?>