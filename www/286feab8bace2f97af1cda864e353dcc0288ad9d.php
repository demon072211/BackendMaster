    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <?php if(session('error')): ?>
                <div class="alert alert-info bg-danger"><?php echo e(session('error')); ?></div>
            <?php endif; ?>
            <form action="<?php echo e(route('auth')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Tên đăng nhập" required name="user_name" >
...
<?php /**PATH /var/app/www/daily/resources/views/login.blade.php ENDPATH**/ ?>