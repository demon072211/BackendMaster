...
//	List<String> GAMES_BAI = Arrays.asList(BA_CAY, TLMN, BAU_CUA, CAO_THAP, MINI_POKER, POKE_GO, XOC_DIA);
	...
	interface MAIL{
		...
		String TITLE_BONUS_DAU="GO88vin Thưởng 170% Gửi Tiền Lần Đầu";
		...
		String TITLE_GIOVANG="Giờ Vàng Gửi Tiền, Nhận Ngàn Thưởng Lớn";
		...
		String TITLE_TAIXIU="Giải đấu Tài Xỉu GO88vin- Rộn ràng hơn 200 Triệu Tiền Thưởng";
		String CONTENT_TAIXIU = "Cơ hội nhận hơn 200 triệu tiền thưởng khi tham gia tại trò chơi tài xỉu tại GO88vin. Để tham gia khuyến mãi xem chi tiết ";
